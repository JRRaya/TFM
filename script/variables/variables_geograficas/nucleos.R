...
carreteras <- sf::st_read(
    here::here("data/variables/variables_geograficas/nucleos/nucleos.gpkg"),
    layer = "T07_07_NucleosUrbanos_pol"  # Comprobar en QGIS
  ) %>% 
...
lista <- buffers(
  ...
  ruta = "data/variables/variables_geograficas/nucleos/nucleos_buffer_"
)
