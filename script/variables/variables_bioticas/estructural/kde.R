...
# 3. Cálculo de los kde de la altura a nivel de píxel para cada uno de los conjuntos de datos LiDAR
for (conjunto in conjuntos_lidar) {
  ...
  kde <- lidR::pixel_metrics(
    teselas_n,
    func = ~lidRmetrics::metrics_kde(
      z = Z, 
      bw = 1,
      zmin = 0.5,
      npeaks = 3
  ...
  terra::writeRaster(
    kde, 
    here::here(paste0("data/variables/variables_bioticas/kde/kde_", conjunto, ".tif"))
  )
