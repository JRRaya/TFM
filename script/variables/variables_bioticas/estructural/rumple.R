...
# 3. Cálculo de los rumple de la altura a nivel de píxel para cada uno de los conjuntos de datos LiDAR
for (conjunto in conjuntos_lidar) {
  ...
  rumple <- lidR::pixel_metrics(
    teselas_n,
    func = ~lidRmetrics::metrics_rumple(
      x = X,
      y = Y,
      z = Z, 
      pixel_size = 10,
  ...
  terra::writeRaster(
    rumple, 
    here::here(paste0("data/variables/variables_bioticas/rumple/rumple_", conjunto, ".tif"))
  )
